...
class PessoaForm extends TPage
{
    ...
    function __construct()
    {
        ...
        $cor_agenda     = new TColor('cor_agenda');
        $historico      = new TText('historico');
        $ref_profissao  = new TDBUniqueSearch('ref_profissao', 'agenda', 'Profissao', 'id', 'descricao');
        ...
        $ref_profissao->addValidation('Profissão', new TRequiredValidator); // obrigatório
        ...
        $row = $this->form->addFields([ new TLabel('Profissão*'), $ref_profissao]);
        $row->layout = ['col-sm-4'];
        ...
        $row = $this->form->addFields([ new TLabel('Cor agenda*'), $cor_agenda]);
        $row->layout = ['col-sm-4'];
