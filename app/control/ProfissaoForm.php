 ...
 * @author  <estelakrein>
 */
class ProfissaoForm extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        $this->setActiveRecord('Profissao');     // defines the active record
        
        // creates the form
        $this->form = new BootstrapFormBuilder('form_Profissao_form');
        $this->form->setFormTitle('Profissão');
        ...
        $this->form->addAction(_t('Cancel'), new TAction(array('ProfissaoList', 'onReload')), 'far:times-circle red');
    ...
    public function onSave($param)
    {
        try
        {
            ...
            $posAction = new TAction(array('ProfissaoList', 'onReload'));
